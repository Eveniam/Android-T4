package com.example.examen_t4_1.Factorys;
...
public class RetrofitFactory {
    ...
    public static Retrofit build(Context context) {
        ...
        SharedPreferences mSharedPref = context.getSharedPreferences("com.example.examen_t4_1.SHARED_PREFERENCES", Context.MODE_PRIVATE);
